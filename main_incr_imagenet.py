...
parser.add_argument('--corr_model_incr', type=str, default='incr_model-imagenet-model.pth.tar',
...
if not os.path.exists("data_generator/imagenet_mean_image.npy"):
    mean_image = None
else:
    mean_image = np.load("data_generator/imagenet_mean_image.npy")
...
if args.probe:
    probe = PatchTracker(args.feat_vis_layer_name, test_all_set, track_grad=args.track_grad, device=test_device,
                         patch_file='imagenet%d' % total_classes, save_file=args.outfile,
