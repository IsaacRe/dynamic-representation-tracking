...
if not os.path.exists("data_generator/image_net_mean_image.npy"):
    mean_image = None
else:
    mean_image = np.load("data_generator/image_net_mean_image.npy")
...
train_set = ImageNet(root="/media/hdd/iamge_net/data/train", transform=train_transform)
test_set = ImageNet(root="/media/hdd/image_net/data/test", transform=test_transform)
