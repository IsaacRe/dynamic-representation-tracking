...
parser.add_argument('--resume_testing', action='store_true',
                    help='Whether to load settings for testing/vis methods that were being computed in the '
                         'previous run')
...
parser.add_argument('--prune_final_iter', type=str, default=None)
...
if args.resume:
    ...
    # if specified, copy settings for evaluation metrics used during the previous run
    # (you still must manually set flags to use these metrics, ie. --feat_corr, --ft_fc, etc.)
